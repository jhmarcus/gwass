...
class Snp:
    ...
    def _get_ancestral_derived_alleles(self):
        ...
        if 'AA' in list(self.rec.info):
            ...
            if (self.ancestral_allele in self.bases) and (self.ancestral_allele in [self.ref_allele, self.alt_allele]): 
...
class Snps:
    ...
    def write_snps(self):
        ...
        header = 'chrom\tpos\tsnp\teffect_allele\tother_allele\talt_allele\tref_allele\t' \
                 'minor_allele\tmajor_allele\tderived_allele\tancestral_allele\tallele_type\t' \
                 'ref_base_l2\tref_base_l1\tref_base_r1\tref_base_r2\tf_sas\tf_afr\tf_eas\tf_eur\tf_amr\n'
